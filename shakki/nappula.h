...
public:
	...
	// omalla tavallaan.
	virtual void annaSiirrot(std::list<std::array<int8_t, 5>>& lista, int alkurivi, int alkusarake, Asema* asema, int vari) = 0;
...
public:
	...
	void annaSiirrot(std::list<std::array<int8_t, 5>>& lista, int alkurivi, int alkusarake, Asema* asema, int vari);
};
...
public:
	...
	void annaSiirrot(std::list<std::array<int8_t, 5>>& lista, int alkurivi, int alkusarake, Asema* asema, int vari);
private:
	void lisaaSotilaanKorotuksetJaTarkistaShakki(std::array<int8_t, 5> siirto, std::list<std::array<int8_t, 5>>& lista, Asema* asema, int vari);
};
